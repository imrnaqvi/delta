...
create table md_rule_input (
  ...
  constraint md_rule_input_alias_ck check (output_alias is null or length(trim(output_alias)) > 0),
...
create sequence md_rule_input_expr_seq start with 1 increment by 1 nocache;
...
create sequence md_source_context_predicate_seq start with 1 increment by 1 nocache;
